...
<div id="features-wrapper">
         ...
         <li><span class="caret">LOGO for window label</span>
          ...
          <ul id="TreeTM">
                              <p><li><span class="caret"> <b> Bordea Ion </b> </span>
                                <ul class="nested">
                                  <li><p><p> Worked on:  </p></p></li>
                                </ul>
                              </li></p>
                              ...
                              <p><li><span class="caret"> <b> Pavlovschi Catalin </b> </span>
                                <ul class="nested">
                                  <li><p>Worked on: Login/ Signup, Profile page, General template/design, PHP DataBase Connection, Scholarly (Introduction), And on this aweasome tree-like script</p></li>
                                </ul>
                              </li></p>
          </ul>
